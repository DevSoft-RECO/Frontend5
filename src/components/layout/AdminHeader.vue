  ...
  >
    ...
    <div class="flex items-center gap-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
            v-else
            class="h-9 w-9 rounded-full bg-[var(--color-azul-cope)] text-white flex items-center justify-center font-bold text-sm border-2 border-[var(--color-verde-cope)] shadow-sm"
        >
            {{ userInitials }}
        </div>

        <!-- Botón Destructivo de Retorno (Según Guía Definitiva) -->
        <button
          @click="handleReturnToMother"
          class="p-2 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200"
